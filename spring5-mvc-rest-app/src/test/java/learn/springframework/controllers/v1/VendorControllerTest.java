...
public class VendorControllerTest extends AbstractRestControllerTest {
	...
	public void createNewVendor() throws Exception {
		...
		when(vendorService.createNewVendor(any(VendorDTO.class))).thenReturn(vendorDTO_1);
	...
	public void updateVendor() throws Exception {
		...
		when(vendorService.saveVendorByDTO(anyLong(),any(VendorDTO.class))).thenReturn(vendorDTO_1);
